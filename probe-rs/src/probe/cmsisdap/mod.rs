...
pub use self::commands::edbg_avr::{
    ATMEGA4809, AvrChipDescriptor, AvrDebugState, AvrMemoryRegion, DEBUG_MTYPE_EEPROM,
    DEBUG_MTYPE_FLASH, DEBUG_MTYPE_SRAM, IceFirmwareVersion, KNOWN_AVR_CHIPS, PkobnUpdiInfo,
    debug_avr_cleanup, debug_avr_enter, debug_avr_halt, debug_avr_hw_break_clear,
    debug_avr_hw_break_set, debug_avr_read_memory, debug_avr_read_pc, debug_avr_read_registers,
    debug_avr_read_sp, debug_avr_read_sreg, debug_avr_reset, debug_avr_run, debug_avr_status,
    debug_avr_step, erase_attached_pkobn_updi, erase_pkobn_updi, identify_attached_pkobn_updi,
